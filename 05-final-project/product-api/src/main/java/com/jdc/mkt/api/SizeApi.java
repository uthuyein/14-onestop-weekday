...
public class SizeApi {
	...
	@PostMapping
	ModificationResult<Integer>save(@Validated @RequestBody SizeForm size){
		return service.save(size);
	}
	
	@PutMapping("{id}")
	ModificationResult<Integer> update(@PathVariable Integer id, @RequestBody SizeForm form ){

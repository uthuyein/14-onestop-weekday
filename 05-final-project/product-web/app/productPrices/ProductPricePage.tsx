...
export default   function ProductPricePage({form,searchForm,isEditMode,onSubmit,handleSearch,categories,products,sizes}:ProductPriceProps){
    ...
    return(
        <div className="flex items-baseline-last justify-align-content-between">
        <div className="w-full space-y-5 p-5">
         ...
         <div className="flex">
        <Form {...searchForm} >      
          <div className=" w-xl h-2 rounded-xl ">
          <form onSubmit={searchForm.handleSubmit(handleSearch)} className="flex gap-2">
            <FormSearch  control={searchForm.control} path="keyword" label="Search" placeholder="Search ..."/>       
          </form>
          </div>
        </Form>
      </div>
